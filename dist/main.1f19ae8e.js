...
var changeTitle = function changeTitle() {
  ...
  var intervalId = setInterval(tempF, 30);
};
...
var timeObj = {
  ...
  init: function init() {
    this.clear();
    document.querySelector(".strong") && document.querySelector(".strong").classList.remove("strong");
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "9975" + '/');
